 ...
 * 
 */
@WebServiceClient(name = "EmployeeService", targetNamespace = "http://impl.service.kaisn.com/", wsdlLocation = "http://localhost:8080/emp-web/webservice/EmployeeService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName EMPLOYEESERVICE_QNAME = new QName("http://impl.service.kaisn.com/", "EmployeeService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/emp-web/webservice/EmployeeService?wsdl");
    ...
    public EmployeeService getEmployeeServicePort() {
        return super.getPort(new QName("http://impl.service.kaisn.com/", "EmployeeServicePort"), EmployeeService.class);
    }
    ...
    public EmployeeService getEmployeeServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://impl.service.kaisn.com/", "EmployeeServicePort"), EmployeeService.class, features);
    }
